const buildModalByPlayerById = (playerId) => {
    axios.get(`http://localhost:8080/api/getPlayer/${playerId}`)
        .then(response => {
...
const modalBuilder = (response) => {
    ...
    const player = response.data.result.list[0];
    ...
    <div class="container mx-1">
        <div class="row">
            ...
            <div class="col-sm-auto mx-0 px-0 d-flex align-items-center">
                <img src="https://cdn.countryflags.com/thumbs/${player.nationality.toLowerCase()}/flag-800.png" width="50" alt="${player.nationality}">
            </div>
...
const modalBuilder = (response) => {
    ...
    console.log("mb called");
    
    modalWrapper = document.createElement('div');
    modalWrapper.id = 'modalWrapper';
    modalWrapper.innerHTML = `
        <div class="modal fade" id="showPlayer" tabindex="-1" aria-labelledby="showPlayerLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content" id="modalContent">
                    <div class="modal-header" id="modalHeader">
                        <h5 class="modal-title" id="showPlayerLabel">${player.name} ${player.surname}</h5>
    ...
    var mymodal = new bootstrap.Modal(modalWrapper);
    mymodal.show();
}*/